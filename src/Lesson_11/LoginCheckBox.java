 ...
 */
public class LoginCheckBox extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        gridPane.getChildren().addAll(userLabel, userInput, passLabel, passInput, checkBox, login);

        login.setOnAction(e -> System.out.println(isInt(userInput, passInput) + " " + checkBox.isSelected()));
